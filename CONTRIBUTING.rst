...
#. use the search functionality `here <https://github.com/FAIR-data-for-CAPACITY /capacity-mapping/issues>`__ to see if someone already filed the same issue;
...
#. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the CAPACITY-mapping repository on GitHub;
